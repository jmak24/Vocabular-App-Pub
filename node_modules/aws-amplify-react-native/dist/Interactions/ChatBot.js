...
var _interactions = _interopRequireDefault(require("@aws-amplify/interactions"));
...
var ChatBot = /*#__PURE__*/function (_Component) {
  ...
  function ChatBot(props) {
    ...
    _this.startRecognizing = _this.startRecognizing.bind(_assertThisInitialized(_this));
    _this.handleMicButton = _this.handleMicButton.bind(_assertThisInitialized(_this));
    ...
    if (_this.props.voiceEnabled) {
      ...
      Voice.onSpeechStart = _this.onSpeechStart.bind(_assertThisInitialized(_this));
      Voice.onSpeechEnd = _this.onSpeechEnd.bind(_assertThisInitialized(_this));
      Voice.onSpeechError = _this.onSpeechError.bind(_assertThisInitialized(_this));
      Voice.onSpeechResults = _this.onSpeechResults.bind(_assertThisInitialized(_this));
    }
  ...
  _createClass(ChatBot, [{
    ...
    key: "submit",
    value: function () {
      var _submit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(voiceResponse) {
        var _this2 = this;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                return new Promise(function (resolve) {
                  return _this2.setState({
                    dialog: [].concat(_toConsumableArray(_this2.state.dialog), [{
              ...
              case 4:
                ...
                _context3.next = 8;
                return _interactions["default"].send(this.props.botName, interactionsMessage);
              ...
              case 11:
                _context3.next = 13;
                return _interactions["default"].send(this.props.botName, this.state.inputText);
              ...
              case 14:
                this.setState({
                  dialog: [].concat(_toConsumableArray(this.state.dialog), [response && response.message && {
                    from: 'bot',
                ...
                path = "".concat(RNFS.DocumentDirectoryPath, "/responseAudio.mp3");
                data = Buffer.from(response.audioStream).toString('base64');
                _context3.next = 21;
                return RNFS.writeFile(path, data, 'base64');

              case 21:
                speech = new Sound(path, '', /*#__PURE__*/function () {
                    ...
                    return regeneratorRuntime.wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            if (!err) {
                              speech.play( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                                return regeneratorRuntime.wrap(function _callee$(_context) {
                                  while (1) {
                                    switch (_context.prev = _context.next) {
                                      case 0:
                                        speech.release();
                                        RNFS.exists(path).then(function (res) {
                                          if (res) {
                                            RNFS.unlink(path);
                                          }
                                        });

                                        if (!(response.dialogState === 'ElicitSlot' && _this2.props.conversationModeOn)) {
                                          _context.next = 5;
                                          break;
                                        }
    ...
    value: function getOnComplete(fn) {
      ...
      return function () {
        ...
        _this3.setState({
          dialog: [].concat(_toConsumableArray(!clearOnComplete && _this3.state.dialog), [message && {
            from: 'bot',
            message: message
          }]).filter(Boolean)
        }, function () {
    ...
    value: function componentDidMount() {
      ...
      if (onComplete && botName) {
        // @ts-ignore
        _interactions["default"].onComplete(botName, this.getOnComplete(onComplete, this));
      }
    }
  }, {
    ...
    key: "onSpeechEnd",
    value: function () {
      var _onSpeechEnd = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
    ...
    value: function onSpeechResults(e) {
      ...
      timer = setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
    ...
    value: function () {
      var _startRecognizing = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    ...
    key: "handleMicButton",
    value: function () {
      var _handleMicButton = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
    ...
    key: "reset",
    value: function () {
      var _reset = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
    ...
    value: function render() {
      ...
      }, this.listItems()), /*#__PURE__*/_react["default"].createElement(ChatBotInputs, {
...
function ChatBotInputs(props) {
  ...
  if (!voiceEnabled && !textEnabled) {
    return /*#__PURE__*/_react["default"].createElement(_reactNative.Text, null, "No Chatbot inputs enabled. Set at least one of voiceEnabled or textEnabled in the props.", ' ');
  }
...
function ChatBotTextButton(props) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_AmplifyUI.AmplifyButton, {
