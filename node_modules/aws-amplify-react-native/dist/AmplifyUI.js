...
exports.SignedOutMessage = exports.Wrapper = exports.AmplifyButton = exports.ErrorRow = exports.Header = exports.LinkCell = exports.PhoneField = exports.FormField = exports.Container = void 0;
...
var FormField = function FormField(props) {
  ...
  }, props.label, " ", props.required ? '*' : ''), /*#__PURE__*/_react["default"].createElement(_reactNative.TextInput, _extends({
    style: theme.input,
    autoCapitalize: "none",
    autoCorrect: false,
...
var PhoneField = /*#__PURE__*/function (_Component) {
  ...
  _createClass(PhoneField, [{
    ...
    value: function onChangeText() {
      ...
      var phoneNumber = cleanedPhone === '' ? '' : "".concat(dialCode).concat(cleanedPhone);
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
        ...
        style: theme.inputLabel
      }, label, " ", required ? '*' : ''), /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
        ...
        return /*#__PURE__*/_react["default"].createElement(_reactNative.Picker.Item, {
          key: dialCode,
          value: dialCode,
          label: dialCode
        });
...
var ErrorRow = function ErrorRow(props) {
  ...
  }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.ERROR_ROW_TEXT)), props.children));
};
...
var Wrapper = function Wrapper(props) {
  ...
  var WrapperComponent = isWeb ? _reactNative.View : _reactNative.TouchableWithoutFeedback;
  var wrapperProps = {
  ...
  return /*#__PURE__*/_react["default"].createElement(WrapperComponent, wrapperProps, props.children);
};
...
var SignedOutMessage = function SignedOutMessage(props) {
  ...
  var message = props.signedOutMessage || _awsAmplify.I18n.get('Please Sign In / Sign Up');

  return /*#__PURE__*/_react["default"].createElement(_reactNative.Text, _extends({
    style: theme.signedOutMessage
  }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.GREETING_SIGNED_OUT_TEXT)), message);
};
