  ...
  _createClass(Connect, [{
    ...
    value: function () {
      var _fetchData2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        ...
        var _this$props, _this$props$query, query, _this$props$query$var, variables, _this$props$mutation, mutation, _this$props$mutation$, mutationVariables, subscription, _this$props$onSubscri, onSubscriptionMsg, _this$getDefaultState, data, mutationProp, errors, hasValidQuery, hasValidMutation, hasValidSubscription, response, subsQuery, subsVars, observable;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                query = _this$props$query.query, _this$props$query$var = _this$props$query.variables, variables = _this$props$query$var === void 0 ? {} : _this$props$query$var, _this$props$mutation = _this$props.mutation;
                _this$props$mutation = _this$props$mutation === void 0 ? {} : _this$props$mutation;
                mutation = _this$props$mutation.query, _this$props$mutation$ = _this$props$mutation.mutationVariables, mutationVariables = _this$props$mutation$ === void 0 ? {} : _this$props$mutation$, subscription = _this$props.subscription, _this$props$onSubscri = _this$props.onSubscriptionMsg, onSubscriptionMsg = _this$props$onSubscri === void 0 ? function (prevData) {
                  return prevData;
                } : _this$props$onSubscri;
                _this$getDefaultState = this.getDefaultState(), data = _this$getDefaultState.data, mutationProp = _this$getDefaultState.mutation, errors = _this$getDefaultState.errors;
