  ...
  return /*#__PURE__*/function (_React$Component) {
    ...
    function WithOAuth(props) {
      ...
      var _config$urlOpener = config.urlOpener,
          urlOpener = _config$urlOpener === void 0 ? defaultUrlOpener : _config$urlOpener;
      _this.urlOpener = urlOpener;
      _this.hostedUISignIn = _this.hostedUISignIn.bind(_assertThisInitialized(_this));
    ...
    _createClass(WithOAuth, [{
      ...
      value: function componentDidMount() {
        ...
        this.setState({
          ...
          _auth["default"].currentAuthenticatedUser().then(function (user) {
            _this2.setState({
              user: user,
              loading: false
            });
      ...
      value: function _getOAuthConfig() {
        if (!_auth["default"] || typeof _auth["default"].configure !== 'function') {
        ...
        var _Auth$configure = _auth["default"].configure(),
            ...
            oauth = _Auth$configure$oauth === void 0 ? undefined : _Auth$configure$oauth; // to keep backward compatibility
      ...
      value: function render() {
        ...
        var _this$props = this.props,
            ...
            otherProps = _objectWithoutProperties(_this$props, ["oauth_config"]);

        var oAuthProps = {
          loading: loading,
          oAuthUser: oAuthUser,
          oAuthError: oAuthError,
          hostedUISignIn: this.hostedUISignIn.bind(this, _auth.CognitoHostedUIIdentityProvider.Cognito),
          facebookSignIn: this.hostedUISignIn.bind(this, _auth.CognitoHostedUIIdentityProvider.Facebook),
          amazonSignIn: this.hostedUISignIn.bind(this, _auth.CognitoHostedUIIdentityProvider.Amazon),
          googleSignIn: this.hostedUISignIn.bind(this, _auth.CognitoHostedUIIdentityProvider.Google),
          customProviderSignIn: function customProviderSignIn(provider) {
            return _this4.hostedUISignIn(provider);
          },
          signOut: this.signOut
        };
        return /*#__PURE__*/React.createElement(Comp, _extends({}, oAuthProps, otherProps));
      }
    }]);
...
var defaultUrlOpener = function defaultUrlOpener(url, redirectUrl) {
  logger.debug("opening url: ".concat(url, ", redirectUrl: ").concat(redirectUrl));
