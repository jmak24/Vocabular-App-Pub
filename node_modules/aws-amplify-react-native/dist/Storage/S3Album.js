...
var S3Album = /*#__PURE__*/function (_Component) {
  ...
  _createClass(S3Album, [{
    ...
    value: function render() {
      ...
      var albumStyle = Object.assign({}, _reactNative.StyleSheet.flatten(theme.album), {
        width: '100%',
        height: height
      });
      var list = this.state.images.map(function (image) {
        return /*#__PURE__*/_react["default"].createElement(_S3Image["default"], {
          key: image.key,
          imgKey: image.key,
          resizeMode: "cover",
          style: {
      ...
      return /*#__PURE__*/_react["default"].createElement(_reactNative.ScrollView, _extends({}, this.props, {
        style: albumStyle
      }), list);
    }
  }]);
